...
!======================================================================
!
! Solves normal Riemann problems for the 1D SHALLOW WATER equations
!     with topography:
!     #        h_t + (hu)_x = 0                       
...
!               bL=hstartest+bR
         ...
         call riemann_aug_JCP(maxiter,3,3,hL,hR,huL, &
              huR,bL,bR,uL,uR,phiL,phiR,sE1,sE2, &
                                          drytol,g,sw,fw)
...
!-----------------------------------------------------------------------
      subroutine riemann_aug_JCP(maxiter,meqn,mwaves,hL,hR,huL,huR, &
        bL,bR,uL,uR,phiL,phiR,sE1,sE2,drytol,g,sw,fw)
